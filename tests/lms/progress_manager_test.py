...
def test_save_multiple_daily_progress_entries(tmp_path):
    ...
    progress1 = {"date": "2026-01-09", "steps": 3, "time": 90, "cards": 8}
    progress2 = {"date": "2026-01-10", "steps": 5, "time": 120, "cards": 10}
...
def test_get_yesterday_progress_returns_correct_entry(tmp_path):
    ...
    progress_yesterday = {"date": yesterday, "steps": 3, "time": 90, "cards": 8}
    progress_today = {"date": today, "steps": 5, "time": 120, "cards": 10}
...
def test_is_valid_progress_with_valid_data():
    ...
    valid_progress = {"date": "2026-01-10", "steps": 5, "time": 120, "cards": 10}
...
def test_get_progress_by_date(tmp_path):
    ...
    progress1 = {"date": "2026-01-08", "steps": 3, "time": 90, "cards": 8}
    progress2 = {"date": "2026-01-09", "steps": 5, "time": 120, "cards": 10}
